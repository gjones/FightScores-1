...
class RowView: UIView {
    ...
    required init(coder aDecoder: NSCoder) {
        ...
        let offWhiteColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 0.2)
        let borderColor = UIColor(red: 151/255, green: 151/255, blue: 151/255, alpha: 0.34).CGColor
