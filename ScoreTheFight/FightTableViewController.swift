...
class FightTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
...
//        navigationItem.titleView = UIImageView(image: UIImage(named: "FSLogo.png"))
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        fights = context.executeFetchRequest(fetchReq, error: &error) as! [Fight]
        fightTableView.reloadData()
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let fightCell:FightCell? = fightTableView.dequeueReusableCellWithIdentifier("fightCell") as? FightCell
